...
function JeffOptions(params) {
	...
	this.strictExclusiveMode = params.strictExclusiveMode || false;
...
Jeff.prototype._processFileGroup = function (nextGroupCb) {
	...
	if (exportMain) {
		...
		classList = helper.filterClasses(allClasses, this._options.exclusiveList, this._options.ignoreList, this._options.ignoreExpression, this._options.strictExclusiveMode);
	}
